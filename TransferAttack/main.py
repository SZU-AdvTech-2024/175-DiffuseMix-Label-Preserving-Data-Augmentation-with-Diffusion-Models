...
def get_parser():
    ...
    parser.add_argument('--attack', default='decowa_s', type=str, help='the attack algorithm', choices=transferattack.attack_zoo.keys())
    parser.add_argument('--epoch', default=16, type=int, help='the iterations for updating the adversarial patch')
    ...
    parser.add_argument('--model', default='inception_v3', type=str, help='the source surrogate model')
