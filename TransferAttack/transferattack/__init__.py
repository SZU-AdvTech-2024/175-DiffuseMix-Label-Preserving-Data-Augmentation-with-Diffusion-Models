...
attack_zoo = {
    ...
    'diffusemix': ('.input_transformation.sdim', 'diffusemix'),
    'BR_fractal': ('.input_transformation.fractal', 'fractal'),
    'BR_fractal_multi': ('.input_transformation.fractal', 'fractal2'),
    ...
    'decowa_f': ('.input_transformation.decowa_f', 'DeCowA_GridDistortion_Fractal'),
    'decowa_a': ('.input_transformation.decowa_a', 'DeCowA_GridDistortion_Improved'),
    'decowa_s': ('.input_transformation.decowa_s', 'DeCowA_GridDistortion_Selective'),
    'grid': ('.input_transformation.GridDistortion', 'DeCowA_GridDistortion_Selective'),
    'l2t': ('.input_transformation.l2t', 'L2T'),
    'bsr': ('.input_transformation.bsr', 'BSR'),
    'spline': ('.input_transformation.spline', 'SPLINE'),
    'decowa_gp': ('.input_transformation.decowa_gp', 'DeCowA_GridDistortion_plus'),
    'decowa_g': ('.input_transformation.decowa_g', 'DeCowA_GridDistortion'),
    ## Targeted
