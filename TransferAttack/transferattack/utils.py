...
cnn_model_paper = ['inception_v3', 'inception_v4','inception_resnet_v2','resnet101','vgg19','densenet121']
# vit_model_paper = ['vit_base_patch16_224', 'pit_b_224',
                #    'visformer_small', 'swin_tiny_patch4_window7_224']
vit_model_paper = ['vit_base_patch16_224','levit_256',  'pit_b_224','cait_s24_224','convit_base', 'tnt_s_patch16_224', 'visformer_small']
...
def load_pretrained_model(cnn_model=[], vit_model=[]):
    for model_name in cnn_model:
        if model_name in models.__dict__:
            ...
            # 使用 timm 来加载不在 torchvision 中的模型
